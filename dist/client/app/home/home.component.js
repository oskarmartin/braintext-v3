    ...
    HomeComponent.prototype.onClick = function (event) {
        ...
        if (endQuoteMarkSum >= 2) {
            ...
            if (isBetweenIndexesLength === 2) {
                ...
                var newText = text.replace(/\./g, '<span class="position"></span>');
                target.innerHTML = newText;
                console.log(newText);
                var offset1 = target.getElementsByClassName('position')[0].offsetLeft;
                var offset2 = target.getElementsByClassName('position')[1].offsetLeft;
                spanNode.style.width = offset2 - offset1 + "px";
                spanNode.style.height = "inherit";
    ...
    HomeComponent.prototype.lookForward = function (nextBlock, builder) {
        ...
        if (this.countMarks(next.innerText, '[\\.\\?\\!]') > 0) {
            ...
            if (indexesForCheck.length == 0) {
                ...
                next.innerHTML = "<span style='background: yellow'>" + forwardText + "</span>" + next.innerText.substring(indexesForCheck[0] + 1);
    ...
    HomeComponent.prototype.lookBack = function (previousBlock, builder) {
        ...
        if (this.countMarks(prev.innerText, '[\\.\\?\\!]') > 0) {
            ...
            if (indexesForCheck.length == 0) {
                ...
                prev.innerHTML = prev.innerText.substring(0, indexesForCheck[indexesForCheck.length - 1] + 1) +
                    "<span style='background:yellow'>" + backText + "</span>";
